...
from SEIQR import cities_config_model, migration_matrix_model, load_weather_data,get_population,get_eco_base
    ...
    while not done and week < max_weeks:
        ...
        for i, city in enumerate(env.cities):
            ...
            results.append({
                ...
                'infection_rate':infection / get_population(city_name) / 10000,
                'r':city.R / get_population(city_name) / 10000
            })
...
def plot_test_results(df_all):
    ...
    for scenario in scenarios:
        ...
        for city in cities:
            ...
            plt.plot(city_data['week'], city_data['infection']/get_population(city),
    ...
    for scenario in scenarios:
        ...
        for city in cities:
            city_data = df_s[df_s['city'] == city]
            plt.plot(city_data['week'], city_data['economic']/get_eco_base(city),
                     label=f"{city}-{scenario}")
